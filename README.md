...
---
### About
![TopLuck](https://cdn.discordapp.com/attachments/701520774598492220/828026414438678588/Shop-UI.png)


[ENG] This is a [PocketMine-MP](https://github.com/pmmp/PocketMine-MP) (or forks) plugin allows to add a customizable store on your server. ! <br/>
<br/>
[FRA] C'est un [PocketMine-MP](https://github.com/pmmp/PocketMine-MP) plugin vous permet d'ajouter une boutique personnalisable sur votre serveur ! <br/>

---
### How to use
[ENG] Configure in config.yml the categories and their items</br>

[FRA] Configurer dans le config.yml les catégories et leurs items</br>
